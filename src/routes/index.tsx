...
export const Route = createFileRoute('/')({
  loader: async () => {
    ...
    return {
      ...
      latestTravel: travelRes.data || null,
      latestJournal: journalRes.data || null,
    };
  },
  component: Dashboard,
});
          ...
          <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div>
              ...
              <p className="mt-3 text-base font-medium text-muted-foreground max-w-xl font-sans">
                Get a high-level overview of the ecosystem. Manage contacts, track attendance logistics, and preview field logs in real-time.
              </p>
            </div>
